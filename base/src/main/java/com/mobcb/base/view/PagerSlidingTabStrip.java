...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private boolean isTabTextBold = false;
    ...
    private int tabBackgroundResId = R.drawable.shape_content_title_bg;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        indicatorWidth = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, indicatorWidth, dm);
...
//		a.recycle();
        ...
        tabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_tab_text_color, indicatorColor);
        ...
        indicatorWidth = a.getDimension(R.styleable.PagerSlidingTabStrip_indicatorWidth, indicatorWidth);
        isTabTextBold = a.getBoolean(R.styleable.PagerSlidingTabStrip_tabTextBold, isTabTextBold);
    ...
    private void addTab(final int position, View tab) {
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                (int) (ScreenUtils.getScreenWidth() / 3), ViewGroup.LayoutParams.FILL_PARENT, 1.0f
        );
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float mid = (lineRight - lineLeft) / 2;

        if (indicatorWidth > 0) {
            canvas.drawRect(mid + lineLeft - indicatorWidth / 2, height - indicatorHeight, mid + lineLeft + indicatorWidth / 2, height, rectPaint);
        } else {
